 ...
 * @method static Media|null find(string $path, ?string $folder = null, ?Model $vault = null)
 * @method static Media findOrFail(string $path, ?string $folder = null, ?Model $vault = null)
 * @method static string|null findUrl(string $path, ?string $folder = null, ?Model $vault = null, string $conversion = '')
